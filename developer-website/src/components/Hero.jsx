...
const Hero = () => {
  return (
    ...
    <div className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        ...
        {/* Hero Text */}
    <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-wider my-8 '>We Build
        <br /> What You Imagine.
    </h1>
        ...
        <div className='flex gap-4 mt-12'>
            <button>
                <a className='border border-[#2a2a2a] py-2 sm:py-3 px-4 sm:px-5 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a]' href="#">
                    View Our Work <i class='bx bxs-briefcase'></i>
                </a>
                ...
                <a className='border border-[#2a2a2a] py-2 sm:py-3 px-4 sm:px-5 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white' href="#">
                    Let's Build Together <i class='bx bx-link-external' ></i>
                </a>                
            </button>
        </div>
    </div>
        ...
        {/* Hero 3D Model */}
         <Spline className='absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-2%] h-full' scene="https://prod.spline.design/FcEi7UgxlxywaHG5/scene.splinecode" />
